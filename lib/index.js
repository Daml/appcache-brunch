...
Manifest = (function() {
  ...
  function Manifest(config) {
    ...
    if (toString.call(this.config.appcache) === '[object Object]') {
      for (k in this.config.appcache) {
        this.options[k] = this.config.appcache[k];
      }
    }
  }
  ...
  Manifest.prototype.write = function(paths, shasum) {
    var p, root;
    if (typeof this.options.staticRoot === 'string') {
